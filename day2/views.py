...
from day2.models import Student
from day2.serializer import StudentSerializer, StudentDeSerializer
...
class StudentAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if stu_id:
            ...
            data = StudentSerializer(employee_objects_all, many=True).data
        ...
        if serializer.is_valid():
            ...
            if emp_obj:
                ...
                return Response({
                    ...
                    "results": StudentSerializer(emp_obj).data
                })
